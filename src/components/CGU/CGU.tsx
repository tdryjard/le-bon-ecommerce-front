    ...
    return (
        <div className="container">
            ...
            le-bon-ecommerce Vous concède un droit d’accès et d’utilisation non exclusif, nominatif, personnel et temporaire. Cette concession ne saurait être considérée comme une cession au sens du Code de la propriété intellectuelle d’un quelconque droit de propriété intellectuelle sur le Service le-bon-ecommerce.fr
                ...
                <p className="text">Tous les sites que nous réalisons sont développés avec les langages et technologies suivantes :<br /><br />
        Javascript<br />
        ReactJs<br />
        NodeJs<br />
        Mysql<br /><br />
        ...
        Malgré les différentes normes de sécurité mises en place, nous ne pouvons garantir une protection inviolable de votre serveur et base de données si une personne malveillante porte atteinte aux données de votre site ou si vous partagez vos identifiants d’administration de votre site, le-bon-ecommerce.fr ainsi que toutes les personnes travaillant à la réalisation de vos sites, ne pourront pas être tenues responsables.
                ...
                <p className="text">
                    Une fois votre site livré via un mail vous fournissant vos identifiants administrateurs, votre boutique en ligne est votre possession et il sera de votre charge d’assumer vos engagements envers vos clients et le respect des lois en matière de vente sur le web.
            ...
            Le contenus fournis par vous lors du renseignement des informations à la commande de votre site ne font pas partis de la propriété intellectuelle de le-bon-ecommerce.fr<br /><br />
            ...
            Le code source, le nom de domaine ainsi que le design de vos sites font eux partis de notre propriété intellectuel, cela est nécessaire afin de prendre en charge du début jusqu’à la fin le développement et le déploiement de votre site ainsi que pour limiter la copie de notre activité et de nos sites développés.
                ...
                <p className="text">
                    Le-bon-ecommerce.fr a accès aux informations fournies lors de la commande d’une boutique en ligne, si celle-ci arrive à son terme, ainsi qu’aux informations de paiement mis à part vos données bancaires.<br/>
            ...
            le-bon-ecommerce.fr s’engage à ne pas céder ni louer les données.<br /><br />
